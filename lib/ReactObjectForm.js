...
var ReactObjectForm = function (_React$Component) {
  ...
  _createClass(ReactObjectForm, [{
    ...
    value: function render() {
      ...
      var rest = _objectWithoutProperties(_props, ['object', 'properties', 'config', 'id']);
      ...
      return _react2.default.createElement(
        'form',
        { className: configtmp.propertyName + '-form' },
        _react2.default.createElement(BaseFormRenderer, _extends({}, rest, configtmp, { id: configtmp.propertyName, object: object }))
      );
    }
  }]);
...
ReactObjectForm.propTypes = {
  ...
  properties: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape(PropertyConfig)),
  changeHandler: _react2.default.PropTypes.func,
...
var GenericValueInput = exports.GenericValueInput = function GenericValueInput(_ref) {
  ...
  var rest = _objectWithoutProperties(_ref, ['value', 'id', 'propertyName', 'placeholder', 'changeHandler', 'disabled']);
...
var BooleanValueInput = exports.BooleanValueInput = function BooleanValueInput(_ref2) {
  ...
  var rest = _objectWithoutProperties(_ref2, ['value', 'id', 'propertyName', 'placeholder', 'changeHandler', 'disabled']);
...
var FieldRenderer = exports.FieldRenderer = function FieldRenderer(_ref3) {
  ...
  var rest = _objectWithoutProperties(_ref3, ['propertyName', 'id', 'object', 'caption', 'label']);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement(BaseFormRenderer, _extends({}, rest, { id: id, propertyName: propertyName, object: object })),
      _react2.default.createElement(
        'span',
        { id: id + "-caption" },
        caption
...
var ObjectFormRenderer = exports.ObjectFormRenderer = function ObjectFormRenderer(_ref4) {
  ...
  var rest = _objectWithoutProperties(_ref4, ['object', 'config', 'changeHandler', 'propertyName', 'id']);

  var childConfig = function childConfig(propertyName) {
    return config ? config.find(function (currentConfig) {
      return currentConfig.propertyName === propertyName;
    }) : null;
  };

  var createChildChangeHandler = function createChildChangeHandler(propertyName) {
  ...
  var fields = Object.keys(object).filter(function (propertyName) {
    var currchildConfig = childConfig(propertyName);
    if (!currchildConfig) {
      return true;
    }
...
var BaseFormRenderer = exports.BaseFormRenderer = function BaseFormRenderer(_ref7) {
  ...
  var rest = _objectWithoutProperties(_ref7, ['object', 'config', 'propertyName', 'options']);

  //handle explicitly configured inputs

  if (options && Array.isArray(options)) {
    return _react2.default.createElement(MultiSelectRenderer, _extends({}, rest, config, { value: object, propertyName: propertyName, options: options }));
  }
  ...
  switch (valueType) {
    ...
    case "boolean":
      return _react2.default.createElement(BooleanValueInput, _extends({}, rest, config, { value: object, propertyName: propertyName }));
    default:
      return _react2.default.createElement(GenericValueInput, _extends({}, rest, config, { value: object, propertyName: propertyName }));
